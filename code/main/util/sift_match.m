function matchResult = sift_match(display_match, im1, im2, varargin)
...
matchResult.f1 = f1(:,matches(1,ok));
matchResult.f2 = f2(:,matches(2,ok));
matchResult.d1 = d1(:,matches(1,ok));
matchResult.d2 = d2(:,matches(2,ok));
